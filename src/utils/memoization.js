 ...
 */
export const memoizedFilter = memoize((data, predicateStr) => {
  // predicateStr is a stringified version of the predicate for caching
  // In practice, we'll use this with specific filter functions
