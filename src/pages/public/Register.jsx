  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      const newUser = {
        ...
        role: formData.role,       // 'student' or 'admin'
        uid: formData.uid,
      ...
      // ✅ ADD ADMIN NOTIFICATION (only if new user is a student)
      if (newUser.role === 'student') {
        ...
        adminUsers.forEach(admin => {
          ...
          adminNotifications.unshift({
            ...
            message: `${newUser.fullName} (${newUser.email}) registered as a student`,
            type: 'new_user',
            url: '/admin'
          });
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-base focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 ${errors.fullName ? 'border-red-500' : 'border-gray-200'}`}
              />
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <select
                ...
                className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-base focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 appearance-none bg-white ${errors.role ? 'border-red-500' : 'border-gray-200'}`}
              >
            ...
            {errors.role && <p className="text-red-500 text-sm mt-1"><i className="fas fa-exclamation-circle text-xs mr-1"></i>{errors.role}</p>}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-base focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 ${errors.uid ? 'border-red-500' : 'border-gray-200'}`}
              />
            </div>
            {errors.uid && <p className="text-red-500 text-sm mt-1"><i className="fas fa-exclamation-circle text-xs mr-1"></i>{errors.uid}</p>}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-base focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 ${errors.phone ? 'border-red-500' : 'border-gray-200'}`}
              />
            </div>
            {errors.phone && <p className="text-red-500 text-sm mt-1"><i className="fas fa-exclamation-circle text-xs mr-1"></i>{errors.phone}</p>}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-base focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 ${errors.email ? 'border-red-500' : 'border-gray-200'}`}
              />
            </div>
            {errors.email && <p className="text-red-500 text-sm mt-1"><i className="fas fa-exclamation-circle text-xs mr-1"></i>{errors.email}</p>}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-12 py-3.5 border-2 rounded-xl text-base focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 ${errors.password ? 'border-red-500' : 'border-gray-200'}`}
              />
            ...
            {errors.password && <p className="text-red-500 text-sm mt-1"><i className="fas fa-exclamation-circle text-xs mr-1"></i>{errors.password}</p>}
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className={`w-full pl-12 pr-4 py-3.5 border-2 rounded-xl text-base focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 ${errors.confirmPassword ? 'border-red-500' : 'border-gray-200'}`}
              />
            </div>
            {errors.confirmPassword && <p className="text-red-500 text-sm mt-1"><i className="fas fa-exclamation-circle text-xs mr-1"></i>{errors.confirmPassword}</p>}
          </div>
