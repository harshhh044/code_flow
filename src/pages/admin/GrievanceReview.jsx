...
const GrievanceReview = () => {
    ...
    const handleSave = async (e) => {
        ...
        setIsSaving(true);
        try {
            await grievanceService.updateStatus(code, reviewForm);
                ...
                <div className="p-10 space-y-12">
                        ...
                        <div>
                            ...
                            {grievance.isAnonymous ? (
                                ...
                                <div className="space-y-3">
                                    {[
                                        { label: 'NAME', value: grievance.first_name },
                                        { label: 'STUDENT ID', value: grievance.student_id },
                                        { label: 'EMAIL', value: grievance.email }
                                    ].map((item, i) => (
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {[
                                    ...
                                    { label: 'SUBMISSION', value: new Date(grievance.submissionDate || grievance.date).toLocaleDateString() },
                    ...
                    <div>
                        ...
                        <div className="bg-slate-50 rounded-3xl p-8 border border-slate-100">
                            <h4 className="text-xl font-black text-slate-800 mb-4">{grievance.subject}</h4>
                    ...
                    {/* Section 3: Admin Adjudication Form - Hidden on Print if empty */}
                    ...
                    {/* Section 4: Print/Final Report View - Only shown if notes exist */}
